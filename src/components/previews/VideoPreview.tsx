...
// plyr-react depends on the browser globals (document/window). Import it dynamically so it only runs on the client.
const Plyr: any = dynamic(() => import('plyr-react'), { ssr: false })
